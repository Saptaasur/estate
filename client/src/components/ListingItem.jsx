...
export default function ListingItem({listing}) {
  return <div className='bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
    <Link to={`/listing/${listing._id}`}>
      <img src={listing.imageUrls[0] || "https://tse1.mm.bing.net/th?id=OIP.dqa2qMB58ZKrboKYnk4DtAHaFj&pid=Api&P=0&h=180"} alt="listing cover" className='h-[320px] sm:h-[220px] w-full object-cover hover:scale-105 transition-scale duration-300'/>
    <div className='p-3 flex flex-col gap-2 w-full'>
      ...
      <p className='txt-sm text-gray-600 line-clamp-2'>
