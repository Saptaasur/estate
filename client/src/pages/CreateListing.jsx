   ...
   if(files.length > 0 && files.length + formData.imageUrls.length < 7){
    ...
    setImageUploadError(false)
      ...
      Promise.all(promises).then((urls) => {
        ...
        setImageUploadError('Image Upload Error (max size of image should be 2mb)');
        setUploading(false);
      })
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex gap-6 flex-wrap'>
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id="regularPrice" min='50'
                max='10000000' onChange={handleChange} value={formData.regularPrice} required className='p-3 border border-gray-300 rounded-lg'/>
             <div className='flex flex-col items-center'><p>Regular Price</p>
              <span className='text-xs'>[Rs. / month]</span></div> 
            </div>
            <div className='flex items-center gap-2'>
              <input type="number" id="discounted price" min='0'
                max='100000' onChange={handleChange} value={formData.discountedPrice}  className='p-3 border border-gray-300 rounded-lg'/>
          ...
          <div className='flex flex-col flex-1 gap-4'>
            ...
            <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase disabled:opacity-80'>{loading ? 'Creating' : 'Create Listing'}</button> 
